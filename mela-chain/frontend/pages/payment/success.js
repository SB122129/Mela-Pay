              ...
              <div className="bg-white rounded-xl shadow-md p-8 mb-8">
                ...
                <div className="grid grid-cols-2 gap-6 mb-6">
                  <div>
                    ...
                    <p className="font-mono text-sm font-semibold">{payment.paymentId}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Amount Paid (USD)</p>
                    <p className="text-2xl font-bold text-gray-900">{formatPrice(payment.totalAmount)}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Amount Paid (DOT)</p>
                    <p className="text-2xl font-bold text-primary-600">{formatDOT(payment.totalAmountDOT)}</p>
                  </div>
                </div>
              ...
              <div className="bg-gradient-to-br from-primary-50 to-secondary-50 rounded-xl p-8 mb-8">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">Access Your Courses</p>
                      <p className="text-sm text-gray-600">
